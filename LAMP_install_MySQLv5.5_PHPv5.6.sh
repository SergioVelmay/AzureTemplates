...
# install LAMP with MySQL 5.5 and PHP 5.6
apt-get -y install apache2 mysql-server-5.5 php5.6 php5.6-mysql

# write some code to show PHP info
echo \<center\>\<h1\>Server LAMP PHP 5.6 Test\</h1\>\<br/\>\</center\> > /var/www/html/phpinfo.php
